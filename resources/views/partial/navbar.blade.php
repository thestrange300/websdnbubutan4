<nav class="z-30 drop-shadow-lg backdrop-blur-sm bg-white/80 rounded-lg mx-20 mt-5 max-sm:bg-black/30 max-sm:mx-3 max-sm:mt-3 sticky top-4 z-50">
    ...
    <div class="sm:hidden" id="mobile-menu">
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        <a href="#" class="text-gray-300 block px-3 py-2 rounded-md text-base font-medium">Team</a>
  
        <a href="#" class="text-gray-300 block px-3 py-2 rounded-md text-base font-medium">Projects</a>
  
        <a href="#" class="text-gray-300 block px-3 py-2 rounded-md text-base font-medium">Calendar</a>
      </div>
    </div>
  </nav>
