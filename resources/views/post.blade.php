...
<div class="flex justify-center pb-5">
    <nav aria-label="Page navigation example">
        <ul class="list-style-none flex">
          <li>
            <a
              class="relative block rounded bg-transparent px-3 py-1.5 text-base text-neutral-600 transition-all duration-300 hover:bg-indigo-500 hover:text-white"
              href="#!"
              >Sebelumnya</a
            >
          </li>
          ...
          <li aria-current="page">
            <a
              class="relative block rounded bg-primary-100 px-3 py-1.5 text-base font-bold text-primary-700 transition-all duration-300"
              href="#!"
              >2
              <span
