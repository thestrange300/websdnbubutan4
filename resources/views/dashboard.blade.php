...
<head>
    ...
    <title>SDN Bubutan IV - Dashboard</title>
    ...
    <div>
        <div class="-mx-6 px-6 py-4">
            <a href="/test" title="home">
                ...
                <p class="float-right text-xl mt-1">SDN Bubutan IV</p>
            </a>
        </div>
        <div class="mt-8 text-center">
            <img src="{{asset('img/profile.png')}}" alt="" class="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28">
            <h5 class="hidden mt-4 text-xl font-semibold text-gray-600 lg:block">Tegar Alwinata</h5>
            <span class="hidden text-gray-400 lg:block">Guru Apa hayo</span>
        </div>
