...
@endif
            ...
            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
              <table class="table-auto min-w-full divide-y divide-gray-300">
                <thead class="bg-gray-50">
                  <tr>
                    <th scope="col" class="py-3.5 text-left pl-3 text-sm font-semibold text-gray-900 sm:pl-6">ID</th>
                    <th scope="col" class="py-3.5 text-left pl-3 text-sm font-semibold text-gray-900">Title</th>
                    <th scope="col" class="py-3.5 text-left pl-3 text-sm font-semibold text-gray-900">Content</th>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  ...
                  <tr>
                    ...
                    <td class="whitespace-normal py-4 pl-3 text-sm truncate text-gray-500">{{ $item->judul }}</td>
                    <td class="whitespace-nowrap text-sm pl-3 text-gray-500 max-w-md">
                    ...
                    <td class="whitespace-nowrap py-4 px-8 text-sm text-gray-500">
                      ...
                      {{-- <form method="post" action="{{ route('delete.post', ['id' => $item->id]) }}" enctype="multipart/form-data"> --}}
                        ...
                        onclick="getdeletepostid({{ $item->id }})"
                        class="inline-flex items-center px-2 py-2 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-md text-white bg-red-600 hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" >
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
    ...
    <script>
      var temp_id;
      var url = "{{ route('delete.post', ['id' => ':id']) }}";
