  ...
  <div class="bg-white drop-shadow-lg rounded-lg md:max-w-md md:mx-auto p-4 fixed inset-x-0 bottom-0 z-50 mb-4 mx-4 md:relative">
    <div class="md:flex items-center">
      ...
      <div class="mt-4 md:mt-0 md:ml-6 text-center md:text-left">
        ...
        <p class="text-sm text-gray-700 mt-1">Sebelum memposting, pastikan kamu telah memeriksa kembali konten yang akan kamu bagikan. Apakah kamu yakin ingin melanjutkan?
        </p>
      </div>
    </div>
